...
function Menu({ selectGameFunc }) {
  ...
  return (
    <div>
      ...
      <button
        className="video-player border-4 relative rounded-2xl cursor-pointer shrink-0"
      ...
      <button
        className="video-player border-4 h-auto relative rounded-2xl cursor-pointer shrink-0"
